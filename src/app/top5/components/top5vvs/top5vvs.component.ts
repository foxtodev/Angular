...
@Component({
  selector: 'app-top5vvs',
  templateUrl: './top5vvs.component.html',
  styleUrls: ['./top5vvs.component.css'],
  /*animations: [
...
export class Top5vvsComponent implements OnInit {

  title = 'rating-top5vvs'; 
...
//     return this.top5Service.getRating(Rank, 'Table').subscribe((data: {}) => {
//       this.rating_tables = data
//       //console.log('Tables ' + this.rating_tables);
...
//     return this.top5Service.getRating(Rank, 'Slot').subscribe((data: {}) => {
//       this.rating_slots = data;
//       //console.log('Slots ' + this.rating_tables);
